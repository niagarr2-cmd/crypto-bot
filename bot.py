...
2. Rate limiting — защита от спама (1 запрос / 30 сек на пользователя)
3. Обработка всех ошибок — бот никогда не падает для пользователя
4. Корректный Markdown — экранирование ответов Claude
5. Graceful shutdown — корректное завершение
6. Пометка демо-данных — честность перед пользователем
"""
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "⚠️ _Сейчас работает на демо-данных._\n"
        "_Реальные данные бирж — в следующем обновлении._\n\n"
        "Выберите действие:",
        parse_mode="Markdown",
