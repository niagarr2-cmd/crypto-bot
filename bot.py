# Crypto AI Agents - Telegram bot with real market data
...
async def start(update, context):
    await update.message.reply_text(
        ...
        "📡 Данные в реальном времени с CoinGecko\n\n"
        "Выберите действие:",
        parse_mode="Markdown",
...
async def analyze_coin(update, context):
    ...
    try:
        ...
        text = (
            ...
            f"📡 _Данные: CoinGecko + Alternative.me_\n"
...
async def market_overview(update, context):
    ...
    await safe_edit_message(query, "⏳ Загрузка данных с CoinGecko...")
...
async def about(update, context):
    ...
    await safe_edit_message(
        ...
        "📈 *PriceAgent*\n"
        "Анализирует реальные данные: цену, RSI(14), "
        "скользящие средние MA50/MA200, объём торгов.\n"
        "Источник: CoinGecko API\n\n"
        "🧠 *SentimentAgent*\n"
        "Анализирует Fear & Greed Index и настроения рынка.\n"
        "Источник: Alternative.me + CoinGecko\n\n"
        "🎯 *OrchestratorAgent*\n"
...
def main():
    ...
    logger.info("Crypto AI Agents Bot started - REAL DATA mode")
